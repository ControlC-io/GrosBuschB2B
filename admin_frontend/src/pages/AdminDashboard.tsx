...
import SeasonalShopsTab from '../components/SeasonalShopsTab';

type Tab = 'settings' | 'products' | 'shops' | 'logs' | 'database' | 'roles';
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-textSecondary dark:text-textSecondary-dark mt-1">Manage products, seasonal shops, system settings, audit logs, database, and user roles.</p>
      </div>
      ...
      {activeTab === 'shops'     && <SeasonalShopsTab />}
