...
type Tab = 'settings' | 'shops' | 'logs' | 'database' | 'roles';
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-textSecondary dark:text-textSecondary-dark mt-1">Manage system settings, seasonal shops, audit logs, database, and user roles.</p>
      </div>
